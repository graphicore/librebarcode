define([
    ...
    var Symbol = (function() {
    function Symbol(value, checksumValue, code, switchedCode, char, isCtrl) {
    ...
    _p.get = function(value) {
        ...
        if(!symbol) {
            ...
            symbol = new Symbol(value, checksumValue, code, switchedCode, char, isCtrl);
